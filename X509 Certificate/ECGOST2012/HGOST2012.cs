...
namespace HGOST2012
{
    class GOST
    {
        // Матрица A для преобразования (L) 
        private ulong[] A = {
        ...
        // Значения перестановки для преобразования (P) 
        private byte[] Tau ={
        ...
        // Интерационные константы для функций ключа
        private byte[][] C = {
        new byte[64]{
        ...
        // Вектор инициализаций
        private byte[] iv = new byte[64];

        // Блок входного сообщения 64 байт = 512 бит
        ...
        //Функция сложения по модулю 2 двух двоичных вектора размерности 512
        ...
        //Преобразование S - Функция подстановки
        ...
        //Преобразования P - Функция перестаноки
        ...
        //Преобразование L - Функция перемешивающая
